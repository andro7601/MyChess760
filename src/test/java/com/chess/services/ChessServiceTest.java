...
public class ChessServiceTest {
    ...
    void ShouldSaveAndWipeFromRedisWhenMatchIsFinalized(){
        ...
        MatchSnapshot snapshot = new MatchSnapshot("123", "r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5Q2/PPPP1PPP/RNB1KBNR w KQkq - 2 3", "WHITE", 11L, 99L, eachplayertimeinmilliseconds,eachplayertimeinmilliseconds, System.currentTimeMillis(),null,"e2e4 e7e5 d2d4 Nc6 d4e5");
    ...
    void shouldRejectMove_WhenMoveIsIllegal() {
        ...
        MatchSnapshot snapshot = new MatchSnapshot("123", "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", "WHITE", 11L, 99L,100000000,100000000,100000000,null,"");
